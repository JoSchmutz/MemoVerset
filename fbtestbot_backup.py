        ...
        for event in output["entry"]:
            for message in event["messaging"]:
                ...
                if message.get("message"):
                    ...
                    print(message_text)
                    #if check_format_input(message_text)=="book_ok":
                    ...
                    for i in range(4):
                        ...
                        time.sleep(3)
                        complexified_verse = complexify_verse(i, verse_final)
                    ...
                    #     send_message(sender_id, str("la référence n'est pas au bon format"))
